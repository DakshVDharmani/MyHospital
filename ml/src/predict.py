"""Shared scoring logic used by evaluate.py and the FastAPI service — loads
the joblib bundle once, scores rows, and translates a predicted risk score
back into the nearest triage label.
"""
